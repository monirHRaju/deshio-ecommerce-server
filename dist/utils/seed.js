...
const seed = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield Promise.all([
        ...
        deliveryZone_model_1.default.deleteMany({}),
    ]);
    console.log('Cleared existing data');
    // ─── Users ───────────────────────────────────────────────────────────
    const [adminUser, demoUser] = yield user_model_1.default.create([
        {
            name: 'Admin User',
    ...
    const mainCategories = yield category_model_1.default.create(mainCategoryData);
    ...
    const products = yield product_model_1.default.insertMany(productData);
    ...
    yield review_model_1.default.insertMany(reviewData);
    ...
    const orderData = products.slice(0, 10).map((product, i) => {
        ...
        return ({
            userId: i % 2 === 0 ? demoUser._id : adminUser._id,
            items: [{ productId: product._id, quantity: 1, price: product.price, title: product.title, image: (_b = (_a = product.images) === null || _a === void 0 ? void 0 : _a[0]) !== null && _b !== void 0 ? _b : '' }],
    ...
    yield order_model_1.default.insertMany(orderData);
    console.log('Orders created');
    // ─── Delivery Zones ────────────────────────────────────────────────────────
    yield deliveryZone_model_1.default.create([
